...
功能: 数据库操作
  ...
  场景: 创建新钱包
    假设 用户 "test_user" 不存在钱包
    当 我为用户 "test_user" 创建钱包
    那么 钱包应该创建成功
    并且 初始余额应该是 0.00
  ...
  场景: 计算钱包余额
    ...
    并且 有一笔支出交易 钱包名称为 "微信" 月份为 "01月" 年份为 "2024年" 金额为 80.00
    当 我计算钱包余额
    那么 余额应该是 120.00
  ...
  场景: 获取钱包的交易记录
    ...
    并且 有一笔支出交易 钱包名称为 "微信" 月份为 "01月" 年份为 "2024年" 金额为 30.00
    当 我获取钱包的交易记录
    那么 应该返回 2 条交易记录 